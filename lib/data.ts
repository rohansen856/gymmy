...
export const users: User[] = [
  ...
  },
  {
    ...
    membershipType: 'premium',
    membershipStatus: 'active',
    profileImage: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=150&auto=format&fit=crop',
...
export const equipment: Equipment[] = [
  {
    ...
    status: 'available',
    image: 'https://images.unsplash.com/photo-1578762560042-46ad127c95ea?q=80&w=300&auto=format&fit=crop',
  ...
  },
  {
    ...
    location: 'Cardio Zone',
    status: 'in-use',
    image: 'https://images.unsplash.com/photo-1570440828762-a3d2a5e67b46?q=80&w=300&auto=format&fit=crop',
...
export const events: Event[] = [
  {
    ...
    description: 'Test your strength in our monthly deadlift competition. Prizes for different weight categories.',
    type: 'competition',
    ...
    image: 'https://images.unsplash.com/photo-1517963879433-6ad2b056d712?q=80&w=300&auto=format&fit=crop',
  ...
  },
  {
    ...
    description: 'How many push-ups can you do in 2 minutes? Join our challenge and find out!',
    type: 'challenge',
    ...
    image: 'https://images.unsplash.com/photo-1598971639058-fab3c3109a00?q=80&w=300&auto=format&fit=crop',
...
export function getHealthMetricsByUserId(userId: string): HealthMetrics | undefined {
  const user = getUserById(userId);
